...
<body>
	<div id="container">
		...
		<div id="wrapper">
			<div id="content">
				<div id="site-introduction">
					<img id="profile" src="<%=request.getContextPath() %>/assets/images/T1_logo.png" style="width:200px">
					<h2>안녕하세요. 정진호의  mysite에 오신 것을 환영합니다.</h2>
					<p>
		...
		<div id="navigation">
			<ul>
				<li><a href="<%=request.getContextPath() %>">정진호</a></li>
